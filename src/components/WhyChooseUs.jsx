        ...
        <>
            <div className="flex flex-col md:flex-row items-center justify-around mt-10 px-6 lg:px-20 gap-10">
                ...
                <div className="flex flex-col items-center md:items-start text-black max-w-lg space-y-6">
                    ...
                    <p className="text-center md:text-xl md:text-left leading-relaxed text-[#63ABFF]">
                        We have 35+ years of experience. We offer marketing <span className='text-[#106CD9]'>and consulting services</span>
                    </p>

                    <div class="grid grid-cols-2 gap-2">
                        <div className=' flex flex-col'>
                            <span className='text-3xl font-bold  text-[#106CD9]'>1550</span>
                            <span>Happy Clients</span>
                        </div>

                        <div className=' flex flex-col'>
                            <span className='text-3xl font-bold text-[#106CD9]'>80%c</span>
                        ...
                        <div className=' flex flex-col'>
                            <span className='text-3xl font-bold text-[#106CD9]'>230+</span>
